...
@section('content')
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <h1>Tabel Aktifitas Requester</h1>
    ...
    <script>
        ...
        firebase.database().ref('act_requester/').on('value', function(snapshot) {
            var value = snapshot.val();
            var htmls = [];
            $i = 1;
            $.each(value, function(index, value){
                const postKey = firebase.database().ref().child('act_requester').push().key;
                if(value) {
                    htmls.push('<tr>\
                <td>'+ $i++ +'</td>\
        		<td>'+ postKey+'</td>\
